...
<body>
    <div id="header_container">
        ...
        <div id="btn_actions">
            ...
            <a href="/payroll-system/php/dashboard.php" id="archive_btn" class="btn btn-secondary" title="Dashboard">
                Dashboard
            </a>
        </div>
        </div>
        ...
        <form id="employee-form">
            ...
            <tbody>
                ...
                <tr data-id="<?= $row['employee_id'] ?>">
                    ...
                    <td>
                    <a href="#" class="action-edit-btn" onclick="loadEditModal(<?= $row['employee_id'] ?>)">Return</a>
                    <a href="archive_employee.php?employee_id=<?= $row['employee_id'] ?>" class="action-delete-btn" onclick="return confirm('Are you sure you want to delete this employee?');">Delete</a>
                    </td>
